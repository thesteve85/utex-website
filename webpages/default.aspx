	...
	<font size="3" face="Arial" class="auto-style15">ATP<sup>3</sup> Training Workshop</font></a></center></font></td></tr>
	 ...
	 <td style="height: 50%" class="curvedEdges">
	  ...
	  <div class="auto-style3" style="width:100%">
  	  ...
  	  <p class="auto-style18" style="margin-bottom:3px;margin-top:1px;margin-left:3px; margin-right:5px;width:90%" ><img src='images/new.gif' border=0 class="auto-style15"><a href="photobioreactor.aspx" title="UTEX Photobioreactors Overview Page"><font size="2"><b>UTEX &amp; AlgEternal announce new Vertical Growth Modules</b></font></a><br>
	  
	  <font size="2" face="Arial">Large-scale (15 and 45 Liter total volume) photobioreactors designed to enable the transfer of basic research from a laboratory setting, to applied research in a scaled setting.</font></p></div></td></tr>
