...
<!--#include virtual="includes/collapsible-menu.html"--><br>
  ...
  <table style="width:100%"><tr>
	  ...
	  information about ordering these strains.</font></p><br><hr>
	  	...
	  	<tr>
	  <div class="feature"><img src="images/workshop-ana-spectro.jpg" width="366px" height="168px"><svg class="glass"><image id="svg-image" width="366px" height="168px" xlink:href="images/workshop-ana-spectro.jpg" clip-path="url(#svg-mask)" /><filter id="svg-blur"><feGaussianBlur stdDeviation="10" /></filter><clipPath id="svg-mask"><circle cx="300" cy="300" r="200" /></clipPath></svg><td  style="width:45%; height: 50%" class="curvedEdges"><div class="text"><div class="auto-style5" style="width:100%;" align="center"> 
		  <font size="2" face="Arial">	 
...
<font face="Arial"><font size="2">May 5-9 :</font></font></td>
		   <td style="width:60%;border-bottom:1px; border-bottom-style:dotted; border-bottom-color:gray; padding-bottom:0px"><font size="2" face="Arial"><center><a href="atp3workshop.aspx" title="Principles & Processes: Algae Culture Maintenance, Production & Downstream Processing">
		   <font size="2" face="Arial" class="auto-style15">ATP<sup>3</sup> 
		   Training 
...
<tr>
<td style="width: 35%;border-bottom:1px; border-bottom-style:dotted; border-bottom-color:gray; padding-bottom:0px" class="auto-style14">
<font face="Arial" size="2">July 21-25 :</font></td><td style="width:60%;border-bottom:1px; border-bottom-style:dotted; border-bottom-color:gray; padding-bottom:0px"><font size="1" face="Arial"><center><a href="workshops1.aspx" title="Intro to Phycology -and- Genetic Modification of Cyanobacteria and Microalgae">
	<font size="3" face="Arial" class="auto-style15">UTEX Training Workshop</font></a></center></font></td>
</tr>
<tr>
<td style="width: 35%;border-bottom:1px; border-bottom-style:dotted; border-bottom-color:gray; padding-bottom:0px" class="auto-style14">
<font face="Arial" size="2">Aug 18-22 :</font></td><td style="width:60%;border-bottom:1px; border-bottom-style:dotted; border-bottom-color:gray; padding-bottom:0px"><font size="1" face="Arial"><center><a href="atp3workshop.aspx" title="Taxonomy & Biochemistry of Microalgae with Commercial Potential">
	<font size="3" face="Arial" class="auto-style15">ATP<sup>3</sup> Training Workshop</font></a></center></font></td>
</tr>
<tr>
<td style="width:35%;border-bottom:1px; border-bottom-style:dotted; border-bottom-color:gray; padding-bottom:0px" class="auto-style14">
<font face="Arial" size="2">Nov 3-7 :</font></td><td style="width:60%;border-bottom:1px; border-bottom-style:dotted; border-bottom-color:gray; padding-bottom:0px"><font size="1" face="Arial"><center><a href="atp3workshop.aspx" title="Large-Scale Algal Cultivation, Harvesting & Downstream Processing">
	<font size="3" face="Arial" class="auto-style15">ATP<sup>3</sup> Training Workshop</font></a></center></font></td></tr>
	 ...
	 <td style="height: 50%" class="curvedEdges">
	  ...
	  <div class="auto-style3" style="width:100%">
  	  ...
  	  <p class="auto-style18" style="margin-bottom:1px;margin-left:3px;margin-right:5px;width:90%" >
	  <img src='images/new.gif' border=0 class="auto-style15"><a href="photobioreactor.aspx" title="UTEX Photobioreactors Overview Page"><font size="2"><b>UTEX Photobioreactors</b></font></a>
		  <br>
	  <font size="2" face="Arial">Laboratory-scale photobioreactors available in 3 different packages.</font></p><hr>

	   
  	  <p class="auto-style18" style="margin-bottom:3px;margin-top:1px;margin-left:3px; margin-right:5px;width:90%" >
	  <img src='../Application%20Data/SSH/temp/images/new.gif' border=0 class="auto-style15"><a href="photobioreactor.aspx" title="UTEX Photobioreactors Overview Page"><font size="2"><b>UTEX &amp; AlgEternal announce new Vertical Growth Modules</b></font></a><br>
	  
	  <font size="2" face="Arial">Large-scale (15 and 60 liter total volume) photobioreactors designed to enable the transfer of basic research from a laboratory setting, to applied research in a scaled setting.</font></p></div></td></tr>
